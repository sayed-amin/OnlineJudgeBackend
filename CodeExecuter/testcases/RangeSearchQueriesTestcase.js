const input = [
    ...
    "1 1\n1\n0 1",  // Single element, query range outside the element's value
...
const output = [
    ...
    "10",  // All elements are the same, so all match each query
    "5",  // Querying from 1 to 5
    "0",  // No element within the range 0 to 0
